...
const STATIC_CACHE_NAME = 'portfolio-static-v1.4';
const DYNAMIC_CACHE_NAME = 'portfolio-dynamic-v1.4';
...
const STATIC_ASSETS = [
  ...
  basePath + '/Wilberto_Pacheco_Batista_Senior_Full_Stack_Engineer.pdf'
];
